...
<!-- TODO: Add SDKs for Firebase products that you want to use
     https://firebase.google.com/docs/web/setup#config-web-app -->
        ...
        <header class='header'>
            ...
            <li><a href="about_me.php" style="text-decoration: none; color: white;" class="hoverable">About Me</a></li>
            <li><a href="hunger_games.php" style="text-decoration: none; color: white;" class= "hoverable">Hunger Games</a></li>
            <li class="customform">
                    <div class="dropdown">
                            <button class="dropbtn"><a style="text-decoration: none;" id="currentPage">Projects</a>
        ...
        <br><br><br><br><br><div id="architecture"><p>Architecture</p></div>
        <br><div id="engineering"><p>Engineering</p></div>
        <br><div id="woodworking"><p>Woodworking</P></div>
        <br><div id="programming"><p>Programming and Robotics</p></div>
        <br><div id="science"><p>Scientific Reports</p></div>
        </article>
        </main>
        <footer>
